...
const struct stmt_map {
	...
	{ .str = ".loc",			.type = LOC			},
	{ .str = ".cfi_startproc",		.type = CFI_STARTPROC		},
	{ .str = ".cfi_endproc",		.type = CFI_ENDPROC		},
	{ .str = ".cfi_offset",			.type = CFI_OFFSET		},
	{ .str = ".cfi_remember_state",		.type = CFI_REMEBER_STATE	},
	{ .str = ".cfi_restore_state",		.type = CFI_RESTORE_STATE	},
	{ .str = ".cfi_restore",		.type = CFI_RESTORE		},
	{ .str = ".cfi_def_cfa_offset",		.type = CFI_DEF_CFA_OFFSET	},
	{ .str = ".cfi_def_cfa_register",	.type = CFI_DEF_CFA_REGISTER	},
	{ .str = ".cfi_def_cfa",		.type = CFI_DEF_CFA		},
	{ .str = ".cfi_sections",		.type = CFI_SECTIONS		},
	{ .str = ".cfi_escape",			.type = CFI_ESCAPE		},
	{ .str = ".balign",			.type = BALIGN			},
	{ .str = ".weak",			.type = WEAK			},
	{ .str = ".value",			.type = VALUE			},
	{ .str = ".uleb128",			.type = ULEB128			},
	{ .str = ".sleb128",			.type = SLEB128			},
	{ .str = 0,				.type = NOSTMT			},
};
...
const char *__stmt_name[] = {
	...
	[CFI_REMEBER_STATE]	= "CFI_REMEBER_STATE",
	[CFI_RESTORE_STATE]	= "CFI_RESTORE_STATE",
	[CFI_RESTORE]		= "CFI_RESTORE",
	[CFI_DEF_CFA_OFFSET]	= "CFI_DEF_CFA_OFFSET",
	[CFI_DEF_CFA_REGISTER]	= "CFI_DEF_CFA_REGISTER",
	[CFI_DEF_CFA]		= "CFI_DEF_CFA",
	[CFI_SECTIONS]		= "CFI_SECTIONS",
	[CFI_ESCAPE]		= "CFI_ESCAPE",
	[BALIGN]		= "BALIGN",
	[WEAK]			= "WEAK",
	[VALUE]			= "VALUE",
	[ULEB128]		= "ULEB128",
